;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="5a8e1ae43e23cfecdd02bd835f919472";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["FomPol5EGOhM"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["FomPol5EGOhM"].options={"anonymizeIp":false,"id":"UA-74089088-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['FomPol5EGOhM'].URLPatterns)){(function(){var options=CloudflareApps.installs['FomPol5EGOhM'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("FomPol5EGOhM"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
