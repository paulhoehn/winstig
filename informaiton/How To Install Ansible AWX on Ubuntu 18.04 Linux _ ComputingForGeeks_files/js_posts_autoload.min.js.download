...
d){return l.isEmpty(c.tdb_globals.permalinkStructure)?c.tdb_globals.wpRestUrl+a+"&"+d:c.tdb_globals.wpRestUrl+a+"?"+d},_getUniqueID:function(){function a(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()},log:function(a,c){}};ezoicSiteSpeed(m, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-dot-ready/).substring(1).slice(0,-1), function(){tdbAutoload.init()})})(jQuery,this,_);
